...
#pragma acc parallel num_gangs(5000) num_workers(128) vector_length(8) copyout(temp[0:len])
    {
...
#pragma acc parallel num_gangs(5000) num_workers(128) vector_length(8) copyin(temp[:len])
    {
#pragma acc loop gang vector
        {
            for (int i = 0; i < len; ++i)
